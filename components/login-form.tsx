    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Acesse seu espaço no Ninho.</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Link
                    ...
                    className="ml-auto font-medium text-lime-600 inline-block text-sm underline-offset-4 hover:underline"
                  >
                    Esqueceu sua senha?
                  </Link>
                </div>
